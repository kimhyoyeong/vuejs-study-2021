<template>
  <div class="board-wrap">
    <div class="type-box">
      <a
        href="#"
        v-on:click="viewChange('boardTypeA')"
        v-bind:class="{ active: selected === 'boardTypeA' }"
        >리스트</a
      >
      <a
        href="#"
        v-on:click="viewChange('boardTypeB')"
        v-bind:class="{ active: selected === 'boardTypeB' }"
        >갤러리</a
      >
      <a
        href="#"
        v-on:click="viewChange('boardTypeC')"
        v-bind:class="{ active: selected === 'boardTypeC' }"
        >웹젠</a
      >
    </div>
